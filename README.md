...
### 데이터 엔지니어링 수명 주기의 5단계: 데이터 서빙 (2024.11.25)
- 조 라이스, 맷 하우슬리 저자  <견고한 데이터엔지니어링> CHAPTER 9.1~9.4 
- 데이터 엔지니어링 스터디 9주차 발표

### 데이터 엔지니어링 수명 주기의 2단계: 데이터 저장 (2024.11.5)
- 조 라이스, 맷 하우슬리 저자  <견고한 데이터엔지니어링> CHAPTER 6.1~6.2
- 데이터 엔지니어링 스터디 6주차 발표
- [블로깅](https://mjrecord.tistory.com/59) 

### 데이터 엔지니어링 수명 주기의 드러나지 않는 주요 요소 (2024.9.24)
- 조 라이스, 맷 하우슬리 저자  <견고한 데이터엔지니어링> CHAPTER 2.2.1~2.2.3
- 데이터 엔지니어링 스터디 2주차 발표
